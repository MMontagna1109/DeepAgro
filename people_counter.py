# Metodos de uso
# Para leer de un video y guardarlo:
# python people_counter.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt --model mobilenet_ssd/MobileNetSSD_deploy.caffemodel --input videos/test.mp4 --output output/output_04.avi
#
# Para leer desde python una camara y guardarlo
...
if not args.get("input", False):
	...
	# vs = VideoStream(src='rtsp://user:@192.4.113.24/ch0_0.h264').start() # Cámara Bosch junto con su respectivo protocolo rstp
	vs = VideoStream(src=0).start()
	time.sleep(2.0)


# si pasamos la direccion de un video como argumento lo toma acá
# otherwise, grab a reference to the video file
else:
	print("[INFO] opening video file...")
	vs = cv2.VideoCapture(args["input"])

# Si vamos a grabar el video en algún lado, inicializamos la variable
